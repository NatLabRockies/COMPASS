...
from compass.extraction.date import _parse_date
...
def test_parse_date_most_frequent():
    """Test `_parse_date` with multiple components with missing elements"""
    dates = [
        {"year": 2023, "month": 7, "day": None},
        {"year": 2024},
        {"year": 2023, "month": 7, "day": None},
    ]
    assert _parse_date(dates) == (2023, 7, None)
